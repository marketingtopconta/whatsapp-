  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4" style={{ background: '#ff8814' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[var(--ds-bg-surface)] border border-[var(--ds-border-default)] rounded-xl pl-11 pr-11 py-3 text-[var(--ds-text-primary)] placeholder:text-[var(--ds-text-muted)] focus:outline-none focus:ring-2 focus:border-transparent" style={{ '--tw-ring-color': '#ff8814' } as React.CSSProperties}
              autoFocus
            />
            <button
              type="button"
          ...
          <button
            ...
            className="w-full mt-6 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-3 rounded-xl transition-colors flex items-center justify-center gap-2" style={{ background: '#ff8814' }}
          >
            {isLoading ? (
